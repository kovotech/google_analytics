...
class GA4_Channel_Sessions:
    ...
    def getTable() -> Table:
        TABLE = Table(
            "ga4_channel_sessions",MetaData(),
            Column('date',Date),
            Column('sessionDefaultChannelGroup',Text),
    ...
    def create_table(self):
        table = GA4_Channel_Sessions.getTable()
    ...
    def map(src:dict):
        ...
        try:
            ...
            output_dict = None
        try:
            output_dict['sessionDefaultChannelGroup'] = src['sessionDefaultChannelGroup']
        except:
            output_dict = None
        try:
    ...
    def insert_record(self,record:dict):
        payload = GA4_Channel_Sessions.map(record)
        table = GA4_Channel_Sessions.getTable()
