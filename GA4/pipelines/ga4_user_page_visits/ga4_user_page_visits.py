...
from GA4.modules.api import ConstructGA4Object, GetGA4Data, ga4_response_to_list_of_dicts, GA4Filter
from GA4.sql.engine import Engine
from GA4.sql.tables.ga4_user_page_visits import GA4_User_Page_Visits
...
sys.path.append(os.environ.get('PROJECT_PATH_SERVER'))
...
METRICS=['totalUsers']
URL_LIST=['/kitchendesign','/kitchendesign/','/kitchendesign/index/index','/kitchendesign/index/index/','/kitchendesign/index','/kitchendesign/index/','/wholesale/','/wholesale/','/wholesale/index','/wholesale/index/','/wholesale/index/index','/wholesale/index/index/']
...
def main():
    ...
    filter = GA4Filter.filter_inlist(field='unifiedPagePathScreen',value_list=URL_LIST)
    ...
    sql_obj = GA4_User_Page_Visits(engine=sql_engine)
...
if __name__ == '__main__':
    try:
        ...
        myLogger(level='info',filename='logs.log',msg=f'{imported_records_count} imported to ga4_user_page_visits table')
