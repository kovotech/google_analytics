...
from GA4.sql.tables.ga4_channel_sessions import GA4_Channel_Sessions
...
def main():
    ...
    sql_obj = GA4_Channel_Sessions(engine=sql_engine)
...
if __name__ == '__main__':
    try:
        ...
        myLogger(level='info',filename='logs.log',msg=f'{imported_records_count} imported to ga4_channel_sessions table')
