...
from GA4.sql.tables.ga4_sessions_date import GA4_Sessions_Date
...
def main():
    ...
    sql_obj = GA4_Sessions_Date(engine=sql_engine)
...
if __name__ == '__main__':
    try:
        ...
        myLogger(level='info',filename='logs.log',msg=f'{imported_records_count} imported to ga4_sessions_date table')
