...
previous_date = dt.today()-datetime.timedelta(days=4)
...
def main():
    ...
    sql_obj = GA4_Clicks_Cost(engine=sql_engine)
...
if __name__ == '__main__':
    try:
        ...
        myLogger(level='info',filename='logs.log',msg=f'{imported_records_count} imported to ga4_clicks_cost table')
